...
```
The mean number of steps taken is `r steps.daily.mean`.
The median number of steps taken is `r steps.daily.median`.
...
```
The interval with the most steps (on average) is `r interval.max.steps`
...
```
There are `r missing.values` missing values in the data set
...
```
The mean number of steps taken after filling in missing values is `r steps.daily.mean.imputed`.
The median number of steps taken after filling in missing values is `r steps.daily.median.imputed`.
